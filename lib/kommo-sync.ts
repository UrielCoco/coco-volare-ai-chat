...
type KommoRes = { ok: boolean; data?: any; error?: string; detail?: any };
...
export async function kommoAttachContact(leadId: number, data: { name: string; email?: string; phone?: string; notes?: string }) {
...
export async function kommoAttachTranscript(leadId: number, transcript: string) {
  return callKommo("attach-transcript", { payload: { lead_id: leadId, transcript } });
}
